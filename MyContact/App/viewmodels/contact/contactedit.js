define(['services/logger', 'services/contact/contactdatacontext', 'plugins/router', 'plugins/dialog'], function (logger, contactdatacontext, router, app) {
    ...
    function activate(routeData) {
        if (!(routeData.toString() === ':id')) {
            ...
            contactdatacontext.getAContactDetail(routeData, contact);
        }
        else {

            contactdatacontext.createContact(contact);
        }
