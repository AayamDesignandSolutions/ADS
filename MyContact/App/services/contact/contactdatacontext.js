...
define([
    ...
    function (system, model, config, logger, partialMapper, router) {
        ...
        function getValidationMessages(error) {
            ...
            catch (e) { alert('[contactdatacontext.js] getValidationMessages : ' + e.message); }
            return 'validation error';
        }

        function queryFailed(error) {
            var msg = '[contactdatacontext.js] Error retrieving data. ' + error.message;
            logError(msg, error);
            throw error;
        }
        ...
        function log(msg, data, showToast) {
            logger.log(msg, data, system.getModuleId(contactdatacontext), showToast);
        }

        function logError(msg, error) {
            logger.logError(msg, error, system.getModuleId(contactdatacontext), true);
        }
        ////////////////////////
